...
public class MifareUtralightEv1Activity extends BaseAppCompatActivity {
    private static final String TAG = "MifareUtralightEv1Activity";
    ...
    private void initView() {
        ...
        toolbar.setTitle(R.string.card_test_MIFARE_Ultralight_ev1);
    ...
    private class CheckCardCallbackV2Impl extends CheckCardCallbackV2.Stub {
        private byte[] authData;//认证数据

        @Override
        public void findMagCard(Bundle info) throws RemoteException {
            LogUtil.e(TAG, "findMagCard,info:" + info);
        }
    ...
    private void handleWriteData() {
        try {
            ...
            LogUtil.e(TAG, "write data " + (success ? "success" : "failed"));
    ...
    private void handleInitAuthData() {
        try {
            ...
            LogUtil.e(TAG, "initialize auth data " + (success ? "success" : "failed"));
        } finally {
            toggleStatus(false);
        }
    }
    ...
    private void handleClearAuthData() {
        try {
            ...
            LogUtil.e(TAG, "clear auth data " + (success ? "success" : "failed"));
        } finally {
            toggleStatus(false);
        }
    }
