...
public class EmvUtil {
    ...
    public static void initKey() {
        try {
            ...
            int result = mSecurityOptV2.savePlaintextKey(AidlConstantsV2.Security.KEY_TYPE_TMK, dataByte, cvByte, AidlConstantsV2.Security.KEY_ALG_TYPE_3DES, 10);
    ...
    public static void initAidAndRid() {
        try {
            EMVOptV2 mEMVOptV2 = MyApplication.mEMVOptV2;
    ...
    public static void setTerminalParam() {
        try {
            EMVOptV2 mEMVOptV2 = MyApplication.mEMVOptV2;
    ...
    public static AidV2 hexStr2Aid(String hexStr) {
        ...
        Map<String, TLV> map = TLVUtil.hexStrToTLVMap(hexStr);
